...
<h1>Four approaches to inserting into the database. Each approach has its page endpoint, except for the API which accesses the API endpoint at /api.</h1>

<div class=note>
	There is also a "word" endpoint at /word/&lt;id&gt; to display the word. Suitable for a representation endpoint.
</div>
